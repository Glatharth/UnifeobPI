...
<div class="row-fluid">
	...
	echo "var sparkline_arr_1 = SparklineTestData();";
	echo "var sparkline_arr_2 = SparklineTestData();";
	echo "var sparkline_arr_3 = SparklineTestData();";
	echo "$(document).ready(function() {";
	echo "shboardTabChecker();";
	echo "LoadKnobScripts(DrawKnobDashboard);";
	echo "LoadSparkLineScript(DrawSparklineDashboard);";
	//echo "LoadMorrisScripts(MorrisDashboard('".$valor."','".$valor2."'))";
	echo "LoadSpringyScripts(SpringyNetmap);";
	echo "$('#ticker-table').beautyHover();";
	echo "CreateStockPage();";
	echo "});";
	echo "</script>";?>
</div>
<!--End Dashboard 2 -->
