  ...
  <div class="col-xs-12 col-sm-6">
    <div class="box">
      ...
      <div class="box-content">
        ...
        <form onsubmit="excluirEquipamento();" method="POST">
          <input type="hidden" id="delequip" value="1"/>
          <div class="row form-group">
            <div class="col-sm-12">
              <select id="del" class="form-control">
                <?php
                $id = "id_equipamentos";
                $tabela = "equipamentos";
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-6">
      <div class="box">
        ...
        <div class="box-content">
          <form onsubmit="adicionarEquipamento();" method="POST">
            ...
            <div class="row form-group">
              <div class="col-sm-12">
                ...
                <select id="id_comodos" class="form-control">
                  <?php
                    $id = "id_comodos";
                    $tabela = "comodos";
                    foreach (ListAll($id, $tabela) as $i) {
